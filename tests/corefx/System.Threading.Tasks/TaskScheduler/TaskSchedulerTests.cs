...
namespace System.Threading.Tasks.Tests
{
    ...
    public static class TaskSchedulerTests
    {
        ...
        {
            MethodInfo getTaskSchedulersForDebuggerMethod = typeof(TaskScheduler).GetMethod("GetTaskSchedulersForDebugger");
        ...
        public static void GetScheduledTasksForDebugger_DebuggerAttached_ReturnsTasksFromCustomSchedulers()
        {
            ...
            MethodInfo getScheduledTasksForDebuggerMethod = typeof(TaskScheduler).GetMethod("GetScheduledTasksForDebugger");
