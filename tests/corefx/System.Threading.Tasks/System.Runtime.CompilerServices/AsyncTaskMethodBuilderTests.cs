...
namespace System.Threading.Tasks.Tests
{
    public class AsyncTaskMethodBuilderTests
    {
        ...
        {
            var twa1 = TaskEx.Run(() => { throw new Exception("uh oh"); });
            var twa2 = Task.Factory.StartNew(() => { throw new Exception("uh oh"); });
            var tasks = new Task[]
            {
                TaskEx.Run(() => { throw new Exception("uh oh"); }),
                Task.Factory.StartNew<int>(() => { throw new Exception("uh oh"); }),
                TaskEx.WhenAll(TaskEx.Run(() => { throw new Exception("uh oh"); }), TaskEx.Run(() => { throw new Exception("uh oh"); })),
                TaskEx.WhenAll<int>(TaskEx.Run(new Func<int>(() => { throw new Exception("uh oh"); })), TaskEx.Run(new Func<int>(() => { throw new Exception("uh oh"); }))),
                TaskEx.WhenAny(twa1, twa2).Unwrap(),
                TaskEx.WhenAny<int>(TaskEx.Run(new Func<Task<int>>(() => { throw new Exception("uh oh"); }))).Unwrap(),
                ...
                TaskEx.Run(() => TaskEx.Run(() => { throw new Exception("uh oh"); })),
                TaskEx.Run(() => TaskEx.Run(new Func<int>(() => { throw new Exception("uh oh"); }))),
                TaskEx.Run(new Func<Task>(() => { throw new Exception("uh oh"); })),
                TaskEx.Run(new Func<Task<int>>(() => { throw new Exception("uh oh"); }))
            };
