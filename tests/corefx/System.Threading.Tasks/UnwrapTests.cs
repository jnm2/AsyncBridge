...
namespace System.Threading.Tasks.Tests
{
    public class UnwrapTests
    {
        ...
        {
            Task<Task> outer = TaskEx.FromResult(inner);
        ...
        {
            Task<Task<string>> outer = TaskEx.FromResult(inner);
        ...
        public void Generic_Completed_NotCompleted(TaskStatus innerStatus)
        {
            ...
            Task<Task<int>> outer = TaskEx.FromResult(inner);
        ...
        public void NonGeneric_AttachedToParent()
        {
            ...
            Task parent = Task.Factory.StartNew(() =>
            {
                ...
                Task inner = TaskEx.FromException(error);
        ...
        public void Generic_AttachedToParent()
        {
            ...
            Task parent = Task.Factory.StartNew(() =>
            {
                ...
                Task<object> inner = TaskEx.FromException<object>(error);
        ...
        public void NonGeneric_DefaultSchedulerUsed()
        {
            ...
            Task.Factory.StartNew(() =>
            {
                ...
                Task<Task> outer = Task.Factory.StartNew(() => TaskEx.Run(() => { }),
                    CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default);
                Task unwrappedInner = outer.Unwrap();
                unwrappedInner.Wait();
        ...
        public void Generic_DefaultSchedulerUsed()
        {
            ...
            Task.Factory.StartNew(() =>
            {
                ...
                Task<Task<int>> outer = Task.Factory.StartNew(() => TaskEx.Run(() => 42),
                    CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default);
                Task<int> unwrappedInner = outer.Unwrap();
                unwrappedInner.Wait();
        ...
        public static IEnumerable<object[]> CompletedNonGenericTasks
        {
            get
            {
                ...
                yield return new object[] { TaskEx.FromCanceled(CreateCanceledToken()) };
                yield return new object[] { TaskEx.FromException(new FormatException()) };
        ...
        public static IEnumerable<object[]> CompletedStringTasks
        {
            get
            {
                yield return new object[] { TaskEx.FromResult("Tasks") };
                yield return new object[] { TaskEx.FromCanceled<string>(CreateCanceledToken()) };
                yield return new object[] { TaskEx.FromException<string>(new FormatException()) };
