// https://github.com/dotnet/corefx/blob/v2.1.0/src/System.Threading.Tasks.Parallel/src/System/Threading/Tasks/Parallel.cs
    ...
    public static class Parallel
    {
            ...
            Func<TLocal> localInit, Action<TLocal> localFinally)
        {
            ...
            CancellationTokenRegistration ctr = (!parallelOptions.CancellationToken.CanBeCanceled)
                            ...
                            : parallelOptions.CancellationToken.Register((o) =>
                            {
                                ...
                                oce = InternalAsyncBridgeExtensions.CreateOperationCanceledException(parallelOptions.CancellationToken);
                                                                                      ...
                                                                                      CancellationToken cancelToken)
        {
            ...
            foreach (Object exObj in exceptions)
            {
                ...
                if (ocEx == null || !cancelToken.Equals(ocEx.GetCancellationToken()))
                    return null;
            }
