// https://github.com/dotnet/coreclr/blob/v2.1.0/src/mscorlib/src/System/Threading/Tasks/TaskContinuation.cs
    ...
    internal class AwaitTaskContinuation : TaskContinuation
    {
        ...
        internal override void Run(Task task, bool canInlineContinuationTask)
        {
            ...
            else
            {
                ...
                ThreadPool.UnsafeQueueUserWorkItem(state => ((AwaitTaskContinuation)state).ExecuteWorkItem(), this);
            }
        }
        ...
        internal static void UnsafeScheduleAction(Action action, Task task)
        {
            ...
            ThreadPool.UnsafeQueueUserWorkItem(state => ((AwaitTaskContinuation)state).ExecuteWorkItem(), atc);
        }
