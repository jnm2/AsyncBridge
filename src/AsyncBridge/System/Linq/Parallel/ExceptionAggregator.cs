// https://github.com/dotnet/corefx/blob/v2.1.0/src/System.Linq.Parallel/src/System/Linq/Parallel/Utils/ExceptionAggregator.cs
...
namespace System.Linq.Parallel
{
    internal static class ExceptionAggregator
    {
        ...
        private static bool ThrowAnOCE(Exception ex, CancellationState cancellationState)
        {
            ...
            if (cancelEx != null &&
                cancelEx.GetCancellationToken() == cancellationState.ExternalCancellationToken
            ...
            if (cancelEx != null &&
                cancelEx.GetCancellationToken() == cancellationState.MergedCancellationToken
