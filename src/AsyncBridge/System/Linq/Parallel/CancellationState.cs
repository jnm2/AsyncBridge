// https://github.com/dotnet/corefx/blob/v2.1.0/src/System.Linq.Parallel/src/System/Linq/Parallel/Scheduling/CancellationState.cs
    ...
    internal class CancellationState
    {
        ...
        internal static void ThrowIfCanceled(CancellationToken token)
        {
            if (token.IsCancellationRequested)
                throw InternalAsyncBridgeExtensions.CreateOperationCanceledException(token);
        }
        ...
        internal static void ThrowWithStandardMessageIfCanceled(CancellationToken externalCancellationToken)
        {
            if (externalCancellationToken.IsCancellationRequested)
            {
                ...
                throw InternalAsyncBridgeExtensions.CreateOperationCanceledException(oceMessage, externalCancellationToken);
            }
        }
    }
}
