// https://github.com/dotnet/corefx/blob/v2.1.0/src/System.Linq.Parallel/src/System/Linq/Parallel/Scheduling/SpoolingTaskBase.cs
    ...
    internal abstract class SpoolingTaskBase : QueryTask
    {
        ...
        protected override void Work()
        {
            ...
            catch (Exception ex)
            {
                ...
                if (oce != null &&
                    oce.GetCancellationToken() == _groupState.CancellationState.MergedCancellationToken
