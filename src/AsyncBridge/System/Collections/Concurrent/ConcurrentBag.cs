// https://github.com/dotnet/corefx/blob/v2.1.0/src/System.Collections.Concurrent/src/System/Collections/Concurrent/ConcurrentBag.cs
...
namespace System.Collections.Concurrent
{
    ...
    public class ConcurrentBag<T> : IProducerConsumerCollection<T>, IReadOnlyCollection<T>
    {
        ...
        private void FreezeBag(ref bool lockTaken)
        {
            ...
            Monitor.Enter(GlobalQueuesLock);
            lockTaken = true;
